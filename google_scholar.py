...
(llm_line,) = ax1.plot(
    years, llm_values, marker="o", color="blue", label="Concept Drift + LLM"
)
...
ax1.annotate(
    f"{data_llm[2024]}",
    xy=(2024, data_llm[2024]),
    xytext=(2024, data_llm[2024] + 300),
    ha="center",
    fontsize=9,
    color="blue",
)
...
(dl_line,) = ax2.plot(
    years, dl_values, marker="o", color="orange", label="Concept Drift + DL"
)
...
ax2.annotate(
    f"{data_dl[2024]}",
    xy=(2024, data_dl[2024]),
    xytext=(2024, data_dl[2024] + 500),
    ha="center",
    fontsize=9,
    color="orange",
)
